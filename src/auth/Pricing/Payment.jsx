            ...
            <div className='bg-white min-h-screen pt-10 px-2 sm:px-10'>
                ...
                <div className='px-3 mt-8'>
                    ...
                    <div className="text-xl flex items-center text-loginBtnClr">
                        <IoIosArrowBack />
                        <Link to={"/register/select-price"} className='text-base font-semibold'>Back to plans</Link>
                    </div>

                    <h2 className='text-3xl sm:text-5xl font-headingFont font-bold mt-6'>Complete your upgrade</h2>

                    <form className='grid lg:grid-cols-2 mt-6 pb-10' onSubmit={handleSubmit(onSubmit)}>

                        <div className=''>
                            <p className='text-2xl font-bold'>Payment</p>
                            <div className='mt-4'>
                                <div className='relative'>
                                    <InputboxNormal label={"Card number"} forId={"Cardnum"} placeholder={"1234 1234 1234 1234"} type={"number"} />
                                ...
                                <div className='flex gap-2 w-full mt-2'>
                                    <div className='w-1/2'>
                                        <InputboxNormal label={"Expiration date"} forId={"expDate"} placeholder={"MM/YY"} type={"number"} />
                                    </div>
                                    <div className='w-1/2 relative'>
                                        <InputboxNormal label={"Security code"} forId={"scCode"} placeholder={"CVC"} type={"number"} />
                            ...
                            <div className='mt-4'>
                                ...
                                <div className='relative mt-4'>
                                    <FloatingInputBox type={"text"} text={"Zip code / Postcode"} register={register} />
                                    {/* For Errors */}
